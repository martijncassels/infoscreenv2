...
PackingCtrl.$inject = ['$scope', '$route','$http','$interval','Helpers','moment'];
...
function PackingCtrl($scope,$route,$http,$interval,Helpers,moment) {
		var vm = this;
		vm.title = '';

		$http.get('/api/packing2018/100/0/0/5')
